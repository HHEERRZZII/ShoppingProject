...
import com.alipay.api.domain.PaymentAccountInfo;
import com.alipay.api.request.AlipayTradePagePayRequest;
import com.alipay.config.AlipayConfig;
import com.herzi.PayServer;
...
import com.herzi.dao.PaymentInfoDao;
...
public class PayServiceImpl extends BaseApiService implements PayService {
    ...
    //这里方法是重载
    public ResponseBase createPayToken(PaymentInfo paymentInfo) {
        //1.创建支付请求信息
    ...
    public ResponseBase findPayToken(@RequestParam("payToken") String payToken) {
        ...
        //4.使用支付id 进行下单
        Long payId1 = Long.parseLong(payId);
        //5.使用支付id查询支付信息
        PaymentInfo paymentInfo = paymentInfoDao.getPaymentInfo(payId1);
        if (paymentInfo == null) {
